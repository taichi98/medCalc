...
def draw_bmi_percentile_chart(bmi, age_months, sex):
    if sex == 1:  # Boys
        file_path = 'data/bfa-boys-percentiles-expanded-tables.xlsx'
    elif sex == 2:  # Girls
        file_path = 'data/bfa-girls-percentiles-expanded-tables.xlsx'
    else:
...
def draw_wfa_percentile_chart(weight, age_months, sex):
    if sex == 1:  # Boys
        file_path = 'data/wfa-boys-percentiles-expanded-tables.xlsx'
    elif sex == 2:  # Girls
        file_path = 'data/wfa-girls-percentiles-expanded-tables.xlsx'
    else:
        raise ValueError("Invalid sex. Please use 1 for male or 2 for female.")
...
def draw_lhfa_percentile_chart(adjusted_lenhei, age_months, sex):
    if sex == 1:  # Boys
        file_path = 'data/lhfa-boys-percentiles-expanded-tables.xlsx'
    elif sex == 2:  # Girls
        file_path = 'data/lhfa-girls-percentiles-expanded-tables.xlsx'
    else:
        raise ValueError("Invalid sex. Please use 1 for male or 2 for female.")
...
def draw_wfl_wfh_percentile_chart(weight, length_or_height, sex, measure_type):
    ...
    if sex == 1:  # Boys
        file_path = f"data/{file_type}-boys-percentiles-expanded-tables.xlsx"
    elif sex == 2:  # Girls
        file_path = f"data/{file_type}-girls-percentiles-expanded-tables.xlsx"
    else:
        raise ValueError("Invalid sex. Please use 1 for male or 2 for female.")
...
def draw_bmi_percentile_chart_above5yr(bmi, age_months, sex):
    if sex == 1:  # Boys
        file_path = 'data/who2007/bfa-boys-perc-who2007-exp.xlsx'
    elif sex == 2:  # Girls
        file_path = 'data/who2007/bfa-girls-perc-who2007-exp.xlsx'
    else:
        raise ValueError("Invalid sex. Please use 1 for male or 2 for female.")
...
def draw_wfa_percentile_chart_above5yr(weight, age_months, sex):
    if sex == 1:  # Boys
        file_path = 'data/who2007/wfa-boys-perc-who2007-exp.xlsx'
    elif sex == 2:  # Girls
        file_path = 'data/who2007/wfa-girls-perc-who2007-exp.xlsx'
    else:
        raise ValueError("Invalid sex. Please use 1 for male or 2 for female.")
...
def draw_lhfa_percentile_chart_above5yr(adjusted_lenhei, age_months, sex):
    if sex == 1:  # Boys
        file_path = 'data/who2007/lhfa-boys-perc-who2007-exp.xlsx'
    elif sex == 2:  # Girls
        file_path = 'data/who2007/lhfa-girls-perc-who2007-exp.xlsx'
    else:
        raise ValueError("Invalid sex. Please use 1 for male or 2 for female.")
